...
<body>
    ...
    <table style="border: 1px solid black;padding: 10px; width: 100%; font-weight:bolder;font-size:25px">
        ...
        <tr>
            <td style="width:60%"><?php echo e($data->shiiping_address2); ?></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td><?php echo e($data->shipping_city . ' - ' . $data->shipping_pincode); ?></td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo e($data->shipping_mobile1); ?></td>
            <?php } else { ?>
            <td> <?php echo e($data->shipping_mobile . ' , ' . $data->shipping_mobile1); ?></td>
            <?php } ?>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"></td>
            <th rowspan="4"> <img width="100" src="<?php echo e(asset('assets/images/logo.png')); ?>" alt=""></th>
        </tr>
        <tr>
            <td></td>
...
<?php /**PATH /home4/sparsvss/sparsh/resources/views/admin/order/DispatchPDF.blade.php ENDPATH**/ ?>