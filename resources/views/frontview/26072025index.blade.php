                        ...
                        <div class="item">
                            <div class="product-item bg-light mb-4">
                                ...
                                <div class="product-img position-relative overflow-hidden">
                                    <a class=""
                                        href="{{ route('product_detail', [$products->category_slug, $products->slugname]) }}"><img class="img-fluid w-100"
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h6 class="text-muted ml-2 px-1"><del>{{ $products->cut_price }}</del> </h6>
                                        <h5> (₹) {{ $products->rate }}</h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                ...
                                <div class="text-center py-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h6 class="text-muted ml-2 px-1"><del>{{ $product->cut_price }}</del> </h6>
                                        <h5> (₹) {{ $product->rate }}</h5>
