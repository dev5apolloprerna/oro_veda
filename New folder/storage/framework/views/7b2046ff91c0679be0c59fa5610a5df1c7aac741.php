                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="post" id="form" action="<?php echo e(route('order.pending')); ?>">
                                                <?php echo csrf_field(); ?>
                                                                            ...
                                                                            <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                ...
                                                                                <tr class="text-center"
                                                                                    ...
                                                                                    <td colspan="2"
                                                                                        ...
                                                                                        data-title="Qty">
                                                                                        <?php echo e($ProductAttribute && $ProductAttribute->product_attribute_qty && $ProductAttribute->name
    ...
    <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('order.statustodispatched')); ?>" autocomplete="off"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/sparsvss/sparsh/resources/views/admin/order/pending.blade.php ENDPATH**/ ?>