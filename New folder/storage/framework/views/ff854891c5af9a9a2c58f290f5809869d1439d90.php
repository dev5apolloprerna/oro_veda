<?php if(Session::has('invalidcaptcha')): ?>
    <style>
        body {
    ...
    <div id="success_tic" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="page-body">
                    <div class="head">
                        <h4 class="text-color pb-3">Invalid captcha code!</h4>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home4/sparsvss/sparsh/resources/views/common/contactalert.blade.php ENDPATH**/ ?>