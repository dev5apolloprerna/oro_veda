<?php $__env->startSection('title', 'Payment Pending List'); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="post" id="form" action="<?php echo e(route('order.pendingOrder')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="row  align-items-center">
                                                    ...
                                                    <div class="col-md-3 mb-2">
                                                        <div class="input-group d-flex justify-content-right">
                                                            ...
                                                            <a href="<?php echo e(route('order.pendingOrder')); ?>"
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <form role="form" method="POST" action="#"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <?php $__currentLoopData = $Pending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <tr class="text-center"
                                                                                ...
                                                                                <td rowspan="<?php echo e($Count); ?>">
                                                                                    <?php echo e($i + $Pending->perPage() * ($Pending->currentPage() - 1)); ?>

                                                                                </td>

                                                                                <td><?php echo e(date('d-m-Y H:i:s', strtotime($pending->created_at))); ?>

                                                                                </td>

                                                                                <td><?php echo e($pending->shipping_cutomerName); ?>

                                                                                </td>

                                                                                <!--<td><?php echo e($pending->shipping_email); ?></td>-->
                                                                                <td><?php echo e($pending->shipping_mobile); ?></td>
                                                                                <td><?php echo e($pending->shipping_city); ?></td>
                                                                                <td><?php echo e($pending->stateName); ?></td>
                                                                                <td><?php echo e($pending->shipping_pincode); ?></td>

                                                                                <td><?php echo e($pending->netAmount); ?></td>
                                                                                <td>
                                                                                    <?php if($pending->isPayment == 0): ?>
                                                                                        Pending
                                                                                    <?php elseif($pending->isPayment == 1): ?>
                                                                                        Success
                                                                                    <?php else: ?>
                                                                                        Failed
                                                                                    <?php endif; ?>
                                                                            ...
                                                                            <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                ...
                                                                                <tr class="text-center"
                                                                                    ...
                                                                                    <td colspan="2" class="image"
                                                                                        data-title="No"><img
                                                                                            src="<?php echo e(asset('uploads/product/thumbnail') . '/' . $item->photo); ?>"
                                                                                            width="50" height="50"
                                                                                            alt="#">
                                                                                    </td>
                                                                                    ...
                                                                                    <td colspan="2"
                                                                                        ...
                                                                                        data-title="Total">
                                                                                        <span> &#x20B9;
                                                                                            <?php echo e($item->rate * $item->quantity); ?></span>
                                                                                    </td>
                                                                            ...
                                                                            <tr style='<?= $pending->orderNote != ''
                                                                                ...
                                                                                <td colspan="10" class="des-ll">
                                                                                    <div
                                                                                        ...
                                                                                        <a href="<?php echo e(route('order.statustocancel', $pending->order_id)); ?>"
                                                                                        ...
                                                                                        <a class="mx-2"
                                                                                            href="<?php echo e(route('order.orderdetail', $pending->order_id)); ?>"
                                                                                            title="Details">
                                                                                            <i
                                                                                        ...
                                                                                        <a class="mx-2" target="_blank"
                                                                                            href="<?php echo e(route('order.DetailPDF', $pending->order_id)); ?>"
                                                                                            title="Pdf Details">
                                                                                            <i
                                                                                        ...
                                                                                        <a class="mx-2" target="_blank"
                                                                                            href="<?php echo e(route('order.DispatchPDF', $pending->order_id)); ?>"
                                                                ...
                                                                <div class="d-flex justify-content-center mt-3">
                                                                    <?php echo e($Pending->appends(request()->except('page'))->links()); ?>
    ...
    <div class="modal fade flip" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('order.dispatchThroughPaymentPendingOrder')); ?>" autocomplete="off"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function multiDelete() {
            $.ajax({
                type: 'Post',
                url: "<?php echo e(route('order.orderMovedToCourier')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/sparsvss/sparsh/resources/views/admin/order/paymentPendingOrder.blade.php ENDPATH**/ ?>