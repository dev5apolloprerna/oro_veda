            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="{{ route('front.blog', ['category' => 'all']) }}"
                                class="d-block filter-btn btn text-start {{ request('category') == 'all' || request('category') == null ? 'active' : '' }}">
                                All
                            </a>
                        </li>
                        ...
                        @foreach ($categories as $category)
                            <li>
                                <a href="{{ route('front.blog', ['category' => $category->strSlug]) }}"
                                    class="d-block filter-btn btn text-start {{ request('category') == $category->strSlug ? 'active' : '' }}">
                                    {{ strtoupper($category->strCategoryName) }}
                                </a>
                            </li>
                        @endforeach
                    </ul>
