        ...
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-md-6" data-aos="fade-left">
                    ...
                    <p class="text-muted">
                        Oroveda Organics was founded with a heartfelt purpose — to bring purity, tradition, and
                        affordability together in everyday wellness. As healthcare professionals, we have witnessed that
                        true health is not just about treatment but about how consciously we live and what we choose to
                        bring into our homes.

                    </p>
                    <p class="text-muted">
                        The name Oroveda, meaning Golden Wisdom, beautifully reflects our philosophy — merging the golden
                        purity of nature (Oro) with the timeless knowledge of Ayurveda and Indian tradition (Veda). Our
                        journey began with pure Bilona Cow Ghee, crafted using age-old methods, staying true to heritage
                        while ensuring quality and trust.
                    </p>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-5">
                    <div class="vm-card vision">
                        ...
                        <p>
                            To make genuine, organic, and traditional products accessible to every household while
                            empowering farmers and preserving the cultural essence of India’s nutritional heritage.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="vm-card mission">
                        ...
                        <p>
                            To revive traditional food wisdom by delivering pure, handcrafted, and affordable products that
                            nourish the body and mind, support sustainable rural livelihoods, and inspire a lifestyle rooted
                            in simplicity and wellness.
                        </p>
                    </div>
                </div>
            ...
            <div class="timeline">
                ...
                <div class="timeline-content ">
                    ...
                    <p class="text-muted small mb-0">
                        ...
                        but a promise — every product embodies authenticity and care. Affordability is equally important, as
                        we strive to make organic living accessible to all. Our deep respect for sustainability guides us
                        toward eco-friendly packaging and carbon-conscious practices, ensuring our growth is gentle on the
                        planet. Above all, we remain committed to trust and tradition — honoring the legacy of our ancestors
                        while adapting to the needs of modern wellness.
                    </p>
                </div>
                <div class="timeline-content">

                    <p class="text-muted small mb-0">
                        At Oroveda Organics, we are not just building a brand, but nurturing a movement — one that
                        celebrates mindful living, supports our farmers, and reconnects us to the roots of health and
                        harmony. As we grow and introduce more natural products like makhana, oils, seeds, nuts, and spices,
                        our promise remains unchanged — to bring pure, affordable, and authentic goodness from the farm to
                        your home.
                    </p>
                </div>
                ...
                <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted small">
                                We believe purity should be a privilege for everyone, not a luxury for few. Oroveda is
                                committed to making authentic, hand-churned ghee accessible to every household without
                                compromising on quality or values.
                            </p>
                        </div>
                    </div>
                </div>
