        ...
        <div class="container-fluid">
            ...
            <div class="row px-xl-5 justify-content-between d-flex">
                <div class="col-lg-4 thank-you-img ">
                    <img src="<?php echo e(asset('assets/front/img/thankyou.gif')); ?>" alt="Thank You" class="img-fluid">
                </div>
                <div class="col-lg-6">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/sparsvss/sparsh/resources/views/frontview/contactthankyou.blade.php ENDPATH**/ ?>