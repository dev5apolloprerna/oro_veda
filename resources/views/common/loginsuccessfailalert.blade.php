            ...
            <div class="modal-content">
                ...
                <div class="page-body">
                    <div class="head">
                        ...
                        <h4 class="text-color pb-3">Register Successfully!</h4>
                    </div>
    ...
    <div id="success_tic" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="page-body">
                    <div class="head">
                        <h4 class="text-color pb-3">OTP Is Not Match!</h4>
                    </div>
    ...
    <div id="success_tic" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="page-body">
                    <div class="head">
                        <h4 class="text-color pb-3">Mobile Is Not Registered!</h4>
                    </div>
