    ...
    <nav>
        <ul class="pagination">
            ...
            <?php if(is_array($element)): ?>
                <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($page == $paginator->currentPage()): ?>
                        <li class="page-item active" aria-disabled="true"><span class="page-link"><?php echo e($page); ?></span></li>
                    <?php elseif($page <= 3 || $page > ($paginator->lastPage() - 3) || ($page >= $paginator->currentPage() - 1 && $page <= $paginator->currentPage() + 1)): ?>
                        <li class="page-item"><a href="<?php echo e($url); ?>" class="page-link"><?php echo e($page); ?></a></li>
                    <?php elseif($page == 4 || $page == $paginator->lastPage() - 3): ?>
...
<?php endif; ?>
<?php /**PATH /home4/sparsvss/sparsh/vendor/laravel/framework/src/Illuminate/Pagination/resources/views/bootstrap-4.blade.php ENDPATH**/ ?>