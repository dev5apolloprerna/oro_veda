<?php $__env->startSection('title', 'Setting List'); ?>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $Setting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="text-center">
                                                <td><?php echo e($i + $Setting->perPage() * ($Setting->currentPage() - 1)); ?>

                                                </td>
                                                <td><?php echo e($data->pagename); ?></td>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form onsubmit="return EditvalidateFile()" method="POST"
                                action="<?php echo e(route('otherpages.update')); ?>" autocomplete="off" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        function getEditData(id) {
            var url = "<?php echo e(route('otherpages.edit', ':id')); ?>";
        ...
        function viewData(id) {
            var url = "<?php echo e(route('otherpages.viewdetail', ':id')); ?>";
            url = url.replace(":id", id);
            if (id) {
                $.ajax({
                    url: url,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\oro_veda\resources\views/admin/setting/otherpages.blade.php ENDPATH**/ ?>