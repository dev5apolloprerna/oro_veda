                    ...
                    <div class="col-md-6">
                        <div class="product-offer mb-30" style="height: 300px;">
                            ...
                            <div class="offer-text">
                                ...
                                <a href="<?php echo e(route('product_list', $offer->slugname)); ?>" class="btn btn-primary">Shop Now</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <a href="<?php echo e(route('product_detail', [$product->category_slug, $product->slugname])); ?>">
                                    <img class="img-fluid w-100" src="<?php echo e($img); ?>" alt="<?php echo e($product->productname); ?>">
                                </a>
                            </div>
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <?php if(!is_null($price)): ?>
                                        <h5 class="mb-0"><?php echo e(money($price)); ?></h5>
                                    <?php endif; ?>

                                    <?php if(!is_null($cut) && (float)$cut > (float)$price): ?>
                                        <small class="text-muted ms-2">
                                            <del><?php echo e(money($cut)); ?></del>
                                        </small>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\oro_veda\resources\views/frontview/index.blade.php ENDPATH**/ ?>